...
export default function SettingsPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch('https://argus-xhgx.onrender.com/api/v1/argus/signoz/health').then(r => r.json()),
      fetch('https://argus-xhgx.onrender.com/api/v1/argus/signoz/config').then(r => r.text()),
    ]).then(([h, cfg]) => {
